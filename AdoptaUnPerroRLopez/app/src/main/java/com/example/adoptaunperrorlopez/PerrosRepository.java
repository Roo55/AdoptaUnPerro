...
public class PerrosRepository implements Repository {
    ...
    this.perros = List.of(
            ...
            new Perro("5", "Daisy", context.getString(R.string.edad_Daisy), context.getString(R.string.raza_bichon_frise), context.getString(R.string.tamano_pequeno), "bichonfrise", context.getString(R.string.descripcion_perro_rocky))
    );
